---
title: Branded category properties
description: Product/category taxonomy, classification, and category-language properties.
---

# Branded category properties
...
| Used on | `brando:BrandedCategory` |
